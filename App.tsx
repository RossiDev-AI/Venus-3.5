...
// Lazy load Lumina Studio to isolate tldraw dependencies
...
const DEFAULT_SETTINGS: AppSettings = {
  // Fix: Removed googleApiKey to satisfy strict process.env.API_KEY exclusive requirement and match AppSettings type definition
  pexelsApiKey: '',
  unsplashAccessKey: '',
  pixabayApiKey: ''
};
            ...
            <div className={`h-full ${activeTab !== 'lumina' ? 'pb-28 lg:pb-0' : ''}`}>
              ...
              {activeTab === 'cinema' && (
                <CinemaLab 
                  ...
                  // Fix: correctly bound cinemaCredits setter
