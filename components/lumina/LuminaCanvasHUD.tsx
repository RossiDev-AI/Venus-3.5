...
import { 
    Zap, Aperture, FlaskConical, Move3d, 
    Shapes, Palette, Wand2, Search,
    Maximize2, ChevronDown, Activity, Cpu
} from 'lucide-react';
    ...
    const applyHUDOp = (op: string) => {
        ...
        selected.forEach(shape => {
            if (shape.type === 'lumina-image') {
                ...
                // Exemplo de ação direta via PixiJS Shaders
